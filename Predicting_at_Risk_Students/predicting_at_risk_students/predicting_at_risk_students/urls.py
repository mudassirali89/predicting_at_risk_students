"""predicting_at_risk_studentsl URL Configuration
...
from predicting_at_risk_students import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Earliest_Possible_Prediction_DataSets/$', remoteuser.Predict_Earliest_Possible_Prediction_DataSets, name="Predict_Earliest_Possible_Prediction_DataSets"),
    ...
    url(r'^Test_Prediction_Ratio/$', serviceprovider.Test_Prediction_Ratio, name="Test_Prediction_Ratio"),
    url(r'^View_Risk_Students_Details/$', serviceprovider.View_Risk_Students_Details, name="View_Risk_Students_Details"),
    url(r'^Train_View_Possible_Prediction_DataSets_Details/$', serviceprovider.Train_View_Possible_Prediction_DataSets_Details, name="Train_View_Possible_Prediction_DataSets_Details"),
